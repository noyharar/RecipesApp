        ...
        <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
            ...
            >
                ...
                <b-form-invalid-feedback v-else-if="!$v.form.firstName.length">
                    First Name length should be between 1-20 characters long
                </b-form-invalid-feedback>
            ...
            >
                ...
                <b-form-invalid-feedback v-else-if="!$v.form.lastName.length">
                    Last Name length should be between 1-20 characters long
                </b-form-invalid-feedback>
            ...
            >
                ...
                <b-form-invalid-feedback
                        v-if="$v.form.password.required && !$v.form.password.specialChar"
                >
                    Has to contain at least one special character
                </b-form-invalid-feedback>
                <b-form-invalid-feedback
                        v-if="$v.form.password.required && !$v.form.password.hasNumber"
                >
            ...
            >
                ...
                <b-form-invalid-feedback v-else-if="!$v.form.email.isEmail">
                    The input is not email formated
                </b-form-invalid-feedback>
            </b-form-group>
            <b-form-group
            ...
            >
                ...
                <b-form-invalid-feedback v-else-if="!validURL($v.form.profilePicture)">
                    The input is not url formated
                </b-form-invalid-feedback>
            </b-form-group>
    ...
    export default {
        ...
        validations: {
            form: {
                ...
                firstName: {
                    required,
                    length: (f) => minLength(1)(f) && maxLength(15)(f),
                    alpha
                },
                lastName: {
                    required,
                    length: (l) => minLength(1)(l) && maxLength(15)(l),
                    alpha
                },
                country: {
                    required
            ...
            async Register() {
                try {
                    const response = await this.axios.post(
                            // this.$root.store.baseURL+"/user/register",
